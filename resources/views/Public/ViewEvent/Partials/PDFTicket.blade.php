                ...
                @if(!$attendee->is_cancelled)
                    <div class="ticket">
                        ...
                        <div class="bottom_section">
                            ...
                            <div class="left_half">
                                <img width="340" height="200" src="https://maps.googleapis.com/maps/api/staticmap?center=880+Harbor+Island,+San+Diego,+CA&zoom=15&scale=2&size=340x200&maptype=roadmap&key={{config('services.google.maps')}}&format=jpg&visual_refresh=true&markers=size:mid%7Ccolor:0xf98500%7Clabel:1%7C{{urlencode($event->venue_name)}}" alt="Map to {{$event->venue_name}}">
